...
| **Threat**                 | Verifier leaks via log emission, weak entropy (predictable RNG), or insufficient length (<43 chars), allowing an attacker who also captured the `code` (OA-3 / OA-9) to exchange it                                                                                                                                                                                                             |
